...
<body class="bgColorGray" style="padding-bottom: 1050px;">
  <header>
    <!-- Fixed navbar -->
  ...
  <div class="row">
   <div class="displayFlex">
    <div class="sideColumn bgColorWhite">
      ...
      <a id="editMembership" href="/editMembership">編輯會員資料</a><br>
      <a id="donateRecord" href="/editMembership_donate">捐贈紀錄</a><br>
      <hr>
      <span class="gray" >店家專區</span><br>
      <a id="storeArea" href="/editMembership_editGoods">編輯物資專區</a><br>
      <a id="getDonateRecord" href="/editMembership_getDonate">獲徵紀錄</a><br>
      <hr>
      <span>登出</span>
    </div>
    ...
    <div class="sideSize distance bgColorGray">
        <h4 id="titleName">編輯會員資料</h4>
      </div>
    <!-- 側邊文字 end-->
    
    <!-- 填表資訊 start-->
    <div class="sideSize distance bgColorWhite" id="removeForm">
        <div class="mb-3 mx-3">
            <label for="exampleFormControlInput1" class="form-label"><h3>姓名</h3><div class="gray">僅供聯絡使用</div></label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
          </div>
          <div class="mb-3 mx-3">
            <label for="exampleFormControlInput1" class="form-label"><h3>聯絡電話</h3><div class="gray">僅供聯絡使用</div></label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="ex:0912-345678">
          </div>
          <div class="mb-3 mx-3">
            <label for="exampleFormControlInput1" class="form-label"><h3>帳號</h3><div class="gray" style="display: none;" >僅供聯絡使用</div></label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="帳號" disabled readonly>
          </div>
          <div class="mb-3 mx-3">
            <label for="exampleFormControlInput1" class="form-label"><h3>密碼</h3><div class="gray">僅供聯絡使用</div></label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="密碼">
          </div>
          <div class="mb-3 mx-3">
        ...
        <div class="sideSize textRight" id="text">點擊「儲存」後，及代表同意店家<a href="#">權利義務規定</a>之內容</div>
        <p></p>
    <!-- 填表資訊 end-->

    <!-- 按鈕 start -->
    <div class="sideSize textRight" id="membershipBtn">
        <button class="btn btn-info buttonStyle2 rounded-pill text-white " role="button">儲存</button>
      </div>
    </div>
  </div>
</div>
