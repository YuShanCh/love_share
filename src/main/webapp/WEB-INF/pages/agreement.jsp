        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              <p>針對捐贈者提供之贈與物品，愛雪兒資訊平台不對其品質或合法性為任何保證，對於品質不佳的物品，徵求者則應審慎判斷是否取用，並可於徵求內容表單中清楚表述物品的需求、標準，一旦完成媒合的物品的捐贈，捐贈者及徵求者均應自行承擔全部責任。捐贈者及徵求者同意對其所贈與之行為自負全部法律責任，且不會就該物品、對愛雪兒資訊平台及其協力營運商、物流商等提出任何索賠或主張，並在此聲明包含贈物網在內之所有運送該物品的參與者，均可無條件免除對於運送標的物的安全性、合適性及與健康、衛生等因素及與前開因素有關的任何損害、索賠或求償之法律與道德責任。</p>
            </li>
          </ul>
          <p>使用者與此平台間所發生起因於本服務或與本服務有關連的紛爭，如有訴訟之必要時，以台灣台北地方法院為第一審管轄法院。</p>
          <h4>隱私權保護政策</h4>
          <p>隱私權保護政策將說明「愛雪兒資訊平台」對於其使用者所留下的個人資料之基本使用情形。這包含您在「愛雪兒資訊平台」所留下的姓名、身分證號碼、出生日期、電子郵件、通訊電話、通訊地址...等必要資訊。完整隱私權保護政策敬請參閱我們的《隱私權聲明》。...等必要資訊。完整隱私權保護政策敬請參閱我們的《隱私權聲明》。</p>
          <ul>
            <li>資料的蒐集及使用</li>
