...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="${pageContext.request.contextPath}/resource/img/indeximage1.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="${pageContext.request.contextPath}/resource\img\indeximage2.jpg" class="d-block w-100" alt="...">
        </div>
      </div>
    ...
    <!-- 理念 -->
    <div class="my-5 mb-3">
      <img src="${pageContext.request.contextPath}/resource/img/index_image_0.png" class="rounded mx-auto d-block" alt="...">
    ...
    <div class="row">
      <div class="col-lg mb-3 mx-3 p-5">
        <img src="${pageContext.request.contextPath}/resource/img/index_image_2.png" class="card-img-top" alt="...">
      ...
      <div class="col-lg mb-3 mx-3 p-5">
        <img src="${pageContext.request.contextPath}/resource/img/index_image_1.png" class="card-img-top" alt="...">
        <div class="mx-5 my-3 text-center">
          <h5>我要徵求物資</h5>
          <p></p>
        </div>
	 ...
	 $(function () {
			...
			$.ajax({
		     ...
		     success(res) {
		    	 ...
		    	 console.log(res.aid);
		    	 if(res.aid != null){
		    		 $('#navAction').text(res.aid + "!");
		    		 $('#loginout').attr('href', "logout.controller");
		    	 }
		    	 else{
		    		 $('#navAction').text("Loging");
		    		 $('#loginout').attr('href', "loginPgeEntry.controller");
		    	 }		    	 
		     }
	        })
	 })	
