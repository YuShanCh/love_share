    ...
    <div class="sideSize distance bgColorWhite">
        <div class="recordStyle">
          ...
          <div class="d-flex ps-3 pe-3" style="width:auto; height:50%; ">
            ...
            <div class="ps-3 pe-3 pt-1" style="width:100%; height:20%; text-align: end;">
              <button class="btn btn-info buttonStyle1 rounded-pill text-white " role="button">再捐一次</button>
